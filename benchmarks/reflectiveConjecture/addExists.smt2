...
(assert (not (models empty (notR (forallR_nat v0_nat (notR (eq_nat (addR (sR (sR (sR (sR (sR (sR (sR (sR zeroR)))))))) (inj_nat v0_nat)) (sR (sR (sR (sR (sR (sR (sR (sR (sR (sR (sR (sR (sR zeroR))))))))))))))))))))
(check-sat)
