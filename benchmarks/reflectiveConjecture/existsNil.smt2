...
(assert (not (models empty (notR (forallR_lst v0_lst (notR (eq_lst (appR (inj_lst v0_lst) (consR (sR (sR (sR (sR (sR (sR (sR zeroR))))))) nilR)) (consR (sR (sR (sR (sR (sR (sR (sR zeroR))))))) nilR))))))))
(check-sat)
