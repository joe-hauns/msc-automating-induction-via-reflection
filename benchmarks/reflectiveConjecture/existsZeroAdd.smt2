...
(assert (not (models empty (notR (forallR_nat v0_nat (notR (forallR_nat (next_nat v0_nat) (eq_nat (addR (inj_nat v0_nat) (inj_nat (next_nat v0_nat))) (inj_nat (next_nat v0_nat))))))))))
(check-sat)
