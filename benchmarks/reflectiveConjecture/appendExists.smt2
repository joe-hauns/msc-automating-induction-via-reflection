...
(assert (not (models empty (notR (forallR_lst v0_lst (notR (eq_lst (appR (consR (sR (sR (sR zeroR))) nilR) (inj_lst v0_lst)) (consR (sR (sR (sR zeroR))) (consR (sR (sR (sR (sR (sR (sR (sR zeroR))))))) nilR)))))))))
(check-sat)
