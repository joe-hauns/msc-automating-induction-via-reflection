...
(assert (not (models empty (forallR_nat v0_nat (forallR_nat (next_nat v0_nat) (eq_nat (mulR (sR (inj_nat v0_nat)) (inj_nat (next_nat v0_nat))) (addR (inj_nat (next_nat v0_nat)) (mulR (inj_nat v0_nat) (inj_nat (next_nat v0_nat))))))))))
(check-sat)
