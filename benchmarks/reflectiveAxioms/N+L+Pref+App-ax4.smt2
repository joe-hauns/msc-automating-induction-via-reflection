...
(assert (not (models empty (forallR_nat v0_nat (forallR_lst v0_lst (forallR_lst (next_lst v0_lst) (eq_lst (appR (consR (inj_nat v0_nat) (inj_lst v0_lst)) (inj_lst (next_lst v0_lst))) (consR (inj_nat v0_nat) (appR (inj_lst v0_lst) (inj_lst (next_lst v0_lst)))))))))))
(check-sat)
