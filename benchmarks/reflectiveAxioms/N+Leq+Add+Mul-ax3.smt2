...
(assert (not (models empty (forallR_nat v0_nat (forallR_nat (next_nat v0_nat) (eq_nat (addR (sR (inj_nat v0_nat)) (inj_nat (next_nat v0_nat))) (sR (addR (inj_nat v0_nat) (inj_nat (next_nat v0_nat))))))))))
(check-sat)
