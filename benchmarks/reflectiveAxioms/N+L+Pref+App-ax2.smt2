...
(assert (not (models empty (forallR_nat v0_nat (forallR_nat (next_nat v0_nat) (forallR_lst v0_lst (forallR_lst (next_lst v0_lst) (orR (notR (orR (notR (prefR (consR (inj_nat v0_nat) (inj_lst v0_lst)) (consR (inj_nat (next_nat v0_nat)) (inj_lst (next_lst v0_lst))))) (notR (notR (orR (notR (eq_nat (inj_nat v0_nat) (inj_nat (next_nat v0_nat)))) (notR (prefR (inj_lst v0_lst) (inj_lst (next_lst v0_lst))))))))) (notR (orR (notR (notR (prefR (consR (inj_nat v0_nat) (inj_lst v0_lst)) (consR (inj_nat (next_nat v0_nat)) (inj_lst (next_lst v0_lst)))))) (notR (notR (notR (orR (notR (eq_nat (inj_nat v0_nat) (inj_nat (next_nat v0_nat)))) (notR (prefR (inj_lst v0_lst) (inj_lst (next_lst v0_lst))))))))))))))))))
(check-sat)
